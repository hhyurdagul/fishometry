...
removed_image_dir = "data/yolo_input/images_removed_from_yolo_predict"
# Get all images in all directories if the directory is not Removed
images_list =  glob(f"{root_image_dir}/*.jpg")
...
def delete_image():
    ...
    new_image_path = os.path.join(removed_image_dir, image_name)
