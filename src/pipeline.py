...
from src.steps.feature_step import FeatureStep
...
def run_pipeline(config, in_data_path=None, out_data_path=None, steps=None):
    ...
    try:
        ...
        print(f"Data file not found at {in_data_path}, creating new one from raw images...")
...
def main():
    parser = argparse.ArgumentParser(description="Fishometry Pipeline")
    parser.add_argument("--config", type=str, required=True, help="Path to config file")
    parser.add_argument("--limit", type=int, default=None, help="Limit number of images to process")
    parser.add_argument("--all-splits", action="store_true", help="Process all splits (train, val, test)")
